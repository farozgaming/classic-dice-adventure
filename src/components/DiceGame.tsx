...
const DiceGame = () => {
  ...
  return (
    <div className="flex-1 bg-dark-200 p-4">
      <div className="flex">
        ...
        <div className="hidden md:block md:flex-1 md:pl-4">
          <div className="bg-dark-300 rounded-lg p-5 h-full">
            <div className="text-gray-300 mb-4">Game result will be displayed</div>
            
            {diceResult !== null && (
              <div className="flex flex-col items-center justify-center h-48">
                <div className="bg-white rounded-lg p-6 flex items-center justify-center mb-10">
            ...
            <div className="relative mt-8">
              <div className="h-2 bg-gradient-to-r from-green-500 via-green-500 to-orange-500 rounded-full overflow-hidden">
                <div
              ...
              />
              <div className="dice-slider-thumb absolute top-0 w-6 h-6 bg-white rounded-full shadow-lg transform -translate-x-1/2 -translate-y-1/2 pointer-events-none" style={{ left: `${sliderValue}%` }}></div>
